...
CompositeGrammar* CompositeGrammar::Create(cmajor::parsing::ParsingDomain* parsingDomain)
{
...
CompositeGrammar::CompositeGrammar(cmajor::parsing::ParsingDomain* parsingDomain_): cmajor::parsing::Grammar(ToUtf32("CompositeGrammar"), parsingDomain_->GetNamespaceScope(ToUtf32("cmajor.syntax")), parsingDomain_)
{
    SetOwner(0);
}

cmajor::parsing::Parser* CompositeGrammar::Parse(const char32_t* start, const char32_t* end, int fileIndex, const std::string& fileName, cmajor::parsing::Scope* enclosingScope)
{
...
class CompositeGrammar::AlternativeRule : public cmajor::parsing::Rule
{
public:
...
class CompositeGrammar::SequenceRule : public cmajor::parsing::Rule
{
public:
...
class CompositeGrammar::DifferenceRule : public cmajor::parsing::Rule
{
public:
...
class CompositeGrammar::ExclusiveOrRule : public cmajor::parsing::Rule
{
public:
...
class CompositeGrammar::IntersectionRule : public cmajor::parsing::Rule
{
public:
...
class CompositeGrammar::ListRule : public cmajor::parsing::Rule
{
public:
...
class CompositeGrammar::PostfixRule : public cmajor::parsing::Rule
{
public:
...
void CompositeGrammar::GetReferencedGrammars()
{
    ...
    cmajor::parsing::Grammar* grammar0 = pd->GetGrammar(ToUtf32("cmajor.syntax.PrimaryGrammar"));
    if (!grammar0)
    {
        grammar0 = cmajor::syntax::PrimaryGrammar::Create(pd);
    }
...
{
    AddRuleLink(new cmajor::parsing::RuleLink(ToUtf32("Primary"), this, ToUtf32("PrimaryGrammar.Primary")));
