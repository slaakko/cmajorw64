...
Symbol::Symbol(SymbolType symbolType_, const Span& span_, const std::u32string& name_) : symbolType(symbolType_), span(span_), name(name_), flags(SymbolFlags::project), parent(nullptr), symbolTable(nullptr)
{
}
