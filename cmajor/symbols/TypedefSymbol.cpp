...
TypedefSymbol::TypedefSymbol(const Span& span_, const std::u32string& name_) : Symbol(SymbolType::typedefSymbol, span_, name_), typeSymbol()
{
}
...
void TypedefSymbol::EmplaceType(TypeSymbol* typeSymbol_, int index)
{
