...
#ifndef CMAJOR_EMITTER_WINDOWS_EMITTER_INCLUDED
#define CMAJOR_EMITTER_WINDOWS_EMITTER_INCLUDED
#include <cmajor/emitter/BasicEmitter.hpp>

namespace cmajor { namespace emitter {

class WindowsEmitter : public BasicEmitter
{
public:
    WindowsEmitter(EmittingContext& emittingContext_, const std::string& compileUnitModuleName_, cmajor::symbols::Module& symbolsModule_);
...
#endif // CMAJOR_EMITTER_WINDOWS_EMITTER_INCLUDED
