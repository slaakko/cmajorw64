...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::ArrayLiteralNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_ArrayLiteralNode_626CB13098008A2C46B156727CB76340707DC08B.html" }];
    drawDiagram(classes);
}
